...
**Status: Phase 5 (event-driven backtester) in progress.** This README
is a stub and will be rewritten properly in Phase 6 — see
`docs/DESIGN.md`, `bench/ENVIRONMENT.md`, and `docs/OPTIMIZATION_LOG.md`
for the real detail in the meantime.
...
5. Event-driven backtester *(current)*
